---
name: showrate-guardian-ghl-calendly-twilio
description: Personalized ShowRate Guardian runtime skill for the GHL Calendly Twilio Demo stack. Use when Hermes needs to operate, audit, or schedule no-show prevention, reminders, reschedules, and status sync against this exact CRM, scheduler, and messaging profile.
version: 1.0.0
author: Signal OS
license: MIT
metadata:
  hermes:
    tags: [showrate, gohighlevel, calendly, twilio]
    category: operations
...
---
# ShowRate Guardian - GHL Calendly Twilio Demo

## Operating Profile

- Client slug: `ghl-calendly-twilio`
...
- SMS: `twilio`
- Email: `gmail`
- Goal: `booked_to_kept` with target `20-30% relative`
