---
name: showrate-guardian-hubspot-calendly-twilio
description: Personalized ShowRate Guardian runtime skill for the HubSpot Calendly Twilio Demo stack. Use when Hermes needs to operate, audit, or schedule no-show prevention, reminders, reschedules, and status sync against this exact CRM, scheduler, and messaging profile.
version: 1.0.0
author: Signal OS
license: MIT
metadata:
  hermes:
    tags: [showrate, hubspot, calendly, twilio]
    category: operations
...
---
# ShowRate Guardian - HubSpot Calendly Twilio Demo

## Operating Profile

- Client slug: `hubspot-calendly-twilio`
...
- SMS: `twilio`
- Email: `gmail`
- Goal: `no_show_rate` with target `25-40% relative reduction`
