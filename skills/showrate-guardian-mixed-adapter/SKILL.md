---
name: showrate-guardian-mixed-adapter
description: Personalized ShowRate Guardian runtime skill for the Mixed Adapter Demo stack. Use when Hermes needs to operate, audit, or schedule no-show prevention, reminders, reschedules, and status sync against this exact CRM, scheduler, and messaging profile.
version: 1.0.0
author: Signal OS
license: MIT
metadata:
  hermes:
    tags: [showrate, custom-crm-adapter, mixed-scheduler-adapter, twilio]
    category: operations
...
---
# ShowRate Guardian - Mixed Adapter Demo

## Operating Profile

- Client slug: `mixed-adapter`
